...
let wilsonBio = Author(firstName: "Wilson", lastName: "Rawls", living: false)
let wilsonBook = Book(title: "Where the Red Fern Grows", author: wilsonBio, pages: 245, numberOfStars: 4.0, description: "This book is about a young boy and his hunting dogs.", genre: "Non-Fictional")

let ronaldBio = Author(firstName: "John Ronald Reuel", lastName: "Tolkein", living: false)
let ronaldBook = Book(title: "The Hobbit", author: ronaldBio, pages: 300, numberOfStars: 4.5, description: "Follows the treasure-seeking quest of hobbit Bilbo Baggins", genre: "Fictional")

let shellyBio = Author(firstName: "Mary", lastName: "Shelly", living: false)
let shellyBook = Book(title: "Frankenstein", author: shellyBio, pages: 280, numberOfStars: 4.75, description: "A young science student named Victor Frankenstein who creates a sentient creature in an unorthodox scientific experiment.", genre: "Fictional")
