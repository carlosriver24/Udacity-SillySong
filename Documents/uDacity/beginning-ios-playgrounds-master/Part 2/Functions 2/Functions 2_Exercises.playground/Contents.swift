...
func overloadingFun(num: Int) -> String {
    return "I'm an Int with the value: \(num)"
}
...
medianAndAverage(1, num2: 5, num3: 6) // (5, 4)
medianAndAverage(2, num2: 1, num3: 6) // (2, 3)
medianAndAverage(3, num2: 15, num3: 9) // (9, 9)
medianAndAverage(-10, num2: 11, num3: 0) // (0, 0.333)
medianAndAverage(1, num2: 2, num3: 5) // (2, 2.666)
medianAndAverage(2, num2: 3, num3: 1) // (2, 2)
medianAndAverage(2, num2: 2, num3: 1) // (2, 1.666)
